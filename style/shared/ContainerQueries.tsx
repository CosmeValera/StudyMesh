...
const ContainerBreakpointContext = createContext<
  ContainerBreakpointContextType | undefined
>(undefined);
...
export const useContainerBreakpoints = () => {
  ...
  if (context === undefined) {
    ...
    console.warn(
      "useContainerBreakpoints must be used within a ContainerBreakpointProvider",
    );
