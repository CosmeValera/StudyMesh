                    ...
                    <Stack direction="row" spacing={1} alignItems="center">
                      ...
                      <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          ...
                          practice prompts from grounded source material. New
                          students should get {freeHostedAiGenerationRange} free
                          hosted AI generations before seeing any payment
                          prompt.
                        </Typography>
                      </Box>
                    </Stack>
              ...
              >
                <Stack spacing={1}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    materials. Hosted AI should consume credits only after an
                    explicit action.
                  </Typography>
                  <LinearProgress />
                </Stack>
