        ...
        children: [
          {
            ...
            type: 'Label',
            props: {
              text: 'A widget can explain something, ask for input, include a button, and show a chart — all as one reusable object.',
              variant: 'body1',
            },
          },
          {
            ...
            type: 'TextField',
            props: {
              label: 'Example answer box',
              placeholder: 'Type a note or value',
              fullWidth: true,
            },
          },
          {
            ...
            props: {
              ...
              variant: 'contained',
              clickAction: 'toast',
              toastMessage: 'Buttons can trigger interactions inside widgets.',
              toastSeverity: 'info',
            },
          },
          {
