...
const TextFieldEditor: React.FC<TextFieldEditorProps> = ({
  ...
  const [variant, setVariant] = useState(
    (props.variant as string) || 'outlined',
  )
  const [size, setSize] = useState((props.size as string) || 'medium')
  const [type, setType] = useState((props.type as string) || 'text')
  const [hasStartAdornment, setHasStartAdornment] = useState(
    Boolean(props.startAdornment),
  )
  const [hasEndAdornment, setHasEndAdornment] = useState(
    Boolean(props.endAdornment),
  )
      ...
      <ComponentPreview>
        ...
        >
          <TextField
            ...
            variant={
              (props.variant as 'outlined' | 'filled' | 'standard') ||
              'outlined'
            }
            ...
            helperText={
              props.error
                ? (props.errorText as string) || 'Problem message'
          ...
          {(Boolean(props.required) || Boolean(props.error)) && (
            ...
            >
              ...
              >
                ...
                {Boolean(props.error) && (
                  <Box component="span" sx={{ mr: 1, color: 'error.main' }}>
                    Error: {props.errorText as string}
                  </Box>
                )}
              </Typography>
            </Box>
          ...
          <Grid item xs={12} sm={6}>
            ...
            {hasStartAdornment && (
              <TextField
                ...
                onChange={(e) =>
                  handleChange('startAdornmentText', e.target.value)
                }
                sx={{
                  mt: isMobile ? 0.5 : 1,
                  '& .MuiInputLabel-root': {
          ...
          <Grid item xs={12} sm={6}>
            ...
            {hasEndAdornment && (
              <TextField
                ...
                onChange={(e) =>
                  handleChange('endAdornmentText', e.target.value)
                }
                sx={{
                  mt: isMobile ? 0.5 : 1,
                  '& .MuiInputLabel-root': {
