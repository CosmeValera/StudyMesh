              ...
              >
                <Stack spacing={isPhone ? 1.25 : 1.5}>
                  <Box>
                    ...
                    >
                      {isPhone
                        ? 'Start with a study block, then save it for your dashboards.'
                        : 'Start with a study block, or drag notes, inputs, charts, and layout blocks from the palette.'}
                    </Typography>
                  </Box>
              ...
              >
                {editMode
                  ? isDragging
                    ...
                    : showSidebar
                      ? 'Add notes, prompts, inputs, charts, and layout containers. Save it to reuse in any study dashboard.'
                      : 'Open the building blocks panel to add notes, prompts, inputs, charts, and layout containers.'
                  : 'This study widget has no saved content yet'}
              </Typography>
            )}
          </Box>
        ) : (
