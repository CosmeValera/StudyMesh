...
const STORAGE_KEY = 'studymesh_custom_widgets'
const VERSION_STORAGE_KEY = 'studymesh_widget_versions'
const LEGACY_STORAGE_KEY = 'aquamesh_custom_widgets'
const LEGACY_VERSION_STORAGE_KEY = 'aquamesh_widget_versions'

const migrateLegacyStorageKey = (nextKey: string, legacyKey: string) => {
  if (
    typeof localStorage === 'undefined' ||
    localStorage.getItem(nextKey) !== null
  ) {
    return
  }
...
migrateLegacyStorageKey(STORAGE_KEY, LEGACY_STORAGE_KEY)
migrateLegacyStorageKey(VERSION_STORAGE_KEY, LEGACY_VERSION_STORAGE_KEY)
